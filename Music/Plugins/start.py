...
def start_pannel():
    buttons = [
        [
            ...
            InlineKeyboardButton(text="قـنـاة السورس╎💡", url=f"https://t.me/Tom01255"),
        ],
        [
            InlineKeyboardButton("🚨╎الاوامـــر╎💁‍♂️", url="https://t.me/Tom01212"),
        ],
        [
            InlineKeyboardButton("⁨⌯ Tom • 𝘚𝘖𝘜𝘙𝘊𝘌 ˹🤺˼⁩", url="https://t.me/Tom01255"),
        ],
    ]
    return (
        "🎛 **{BOT_NAME} اهلا انا بوت تشغيل  موسيقي في المحدثات الصواتية للاستماع بي [ᗪᗴᐯ. TOᗰ 𖢅](http://t.me/UU_333)**",
        buttons,
    )
...
async def settings(_, message: Message):
    ...
    _check = await get_assistant(c_id, "المساعد")
    if not _check:
        assis = {
            "volume": 100,
        }
