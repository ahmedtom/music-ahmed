...
🔖  Is A Bot That Can Be Used To Listen To Songs In Voice Chat And Can Play Videos In Voice chat iam work from source music tom!
...
🔖 انا بوت يمكن استخدامه للاستماع إلى الأغاني في الدردشة الصوتية ويمكن تشغيل مقاطع الفيديو في الدردشة الصوتيه انا اعمل على سورس توم ميوزك!
-›[ᗪᗴᐯ. TOᗰ 𖢅](http://t.me/UU_333)
-› [ᔕOᑌᖇᑕE TOᗰ 𖢅](http://t.me/Tom01255)
...
""",
        ...
        [
            ...
            InlineKeyboardButton("📡╎قناه السورس", url=f"https://t.me/Tom01255"),
        ],
        [
            InlineKeyboardButton("🎟╎الاوامر", url="https://t.me/Tom01212"),
        ],
        [
           InlineKeyboardButton("🏴‍☠️╎المبرمج", callback_data="UU_333"),
        ],
        [
    ...
    await query.edit_message_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [        
                    InlineKeyboardButton(
                        "⁨⌯ ٰ𝘿ٌِ𝙀ٓ𝙑 ٰTOM ˹✈🔥˼⁩", url=f"https://t.me/UU_333"
                    ),
                ],
                [                  
                    InlineKeyboardButton(
